...
use TODO\Resolver\RemoveResolver;
use TODO\Resolver\ResolverInterface;
use Zend\Hydrator\HydratorInterface;

/**
 * Class RemoveResolverTest
 * @package TODOTest\Resolver
 */
class RemoveResolverTest extends TestCase
{
    protected $resolver;
    ...
    protected function setUp(): void
    {
        ...
        $objectManager
            ->remove(Argument::type(Task::class))
            ->willReturn();
        ...
        $this->resolver = new RemoveResolver(
    ...
    public function testCallResolveMethodWithCorrectlyValues()
    {
        $this->assertTrue($this->resolver->resolve([
            'operation' => ResolverInterface::OPERATION_DROP,
            'data' => [
